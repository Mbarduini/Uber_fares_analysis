...
# Outputs: heatmap_correlacion_uber_1.png, histograma_tarifas_1.png, 
#          histograma_distancia_1.png, histograma_hora.png,
#          boxplot_tarifas_1.png
# =============================================================================
...
histograma_hora <- ggplot(uber_fares_dataset_variables, aes(x = hour)) +
...
barras_dias_semana <- ggplot(uber_fares_dataset_variables, aes(x = dia_semana)) +
  geom_bar(fill = colores_uber["primario"], 
           color = "white",
           alpha = 0.8,
           width = 0.7) +
  ...
  labs(
    title = "Viajes por Día de la Semana - Uber",
    subtitle = "Distribución de frecuencia semanal",
    x = NULL,
    y = "Número de viajes"
  )
