...
Luego de tener la base y la estructura de carpetas tal como esta planteada en el Rproject, el dataset original se encontrara en raw
y podrá ser referenciado via el path relativo planteado en el script 01_cargar_datos
